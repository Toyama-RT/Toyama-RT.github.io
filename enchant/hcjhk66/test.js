...
//カタカナ文字盤
   // 一列目
     ...
     var obj = document.getElementById('ktbun');
	 obj.addEventListener("click", function() {
      new Audio('./snd/se3.mp3').play();
...
document.activeElement.blur();//Androidでキーボード出現を止めるためフォーカスを外す
    ...
    function Bunnum(param) {
      ...
      var elem2 = document.getElementById("ktbun");

      switch (param) {
        case 1:
          elem.src = "./img/bun01.png";
          elem2.src = "./img/bun01.png";
          break;
        case 2:
          elem.src = "./img/bun02.png";
          elem2.src = "./img/bun02.png";
          break;
        case 3:
          elem.src = "./img/bun03.png";
          elem2.src = "./img/bun03.png";
          break;
        case 4:
          elem.src = "./img/bun04.png";
          elem2.src = "./img/bun04.png";
          break;
        case 5:
          elem.src = "./img/bun05.png";
          elem2.src = "./img/bun05.png";
          break;
        case 6:
          elem.src = "./img/bun06.png";
          elem2.src = "./img/bun06.png";
          break;
        case 7:
          elem.src = "./img/bun07.png";
          elem2.src = "./img/bun07.png";
          break;
        case 8:
          elem.src = "./img/bun08.png";
          elem2.src = "./img/bun08.png";
          break;
        case 9:
          elem.src = "./img/bun09.png";
          elem2.src = "./img/bun09.png";
          break;
        case 10:
          elem.src = "./img/bun10.png";
          elem2.src = "./img/bun10.png";
          break;
        default:
          elem.src = "./img/bun01.png";
          elem2.src = "./img/bun01.png";
