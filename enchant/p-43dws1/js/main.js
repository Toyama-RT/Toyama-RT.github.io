...
window.onload = function() {
    ...
    var scy = wih * 2.5 / 1024;　// 文字キー高さ係数
            ...
            title3.text = 'web speech api のテスト用　日本語　こんにちは　と　さようなら　と　Thank you!　は、speechSynthesis　api　で発声　ごめんなさい　は　mp3ファイルを再生しています。こんにちは　さようなら　が発声したら、日本語に対応しています。Thank you!　が英語で発声したら、英語に対応しています。ごめんなさい　が発声できない場合は、スピーカーの音量を確かめてください。';
...
*/
        ...
        return;
            ...
            var synthes = new SpeechSynthesisUtterance();
               ...
               //synthes.lang = 'en-US';
               //synthes.text = 'hello, Now, We start the enchant.js and thank you';
