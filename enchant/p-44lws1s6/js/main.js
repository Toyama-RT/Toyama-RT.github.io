enchant(); // enchant.js を利用したコミュニケーションエイド web speech api text to speech の導入

// 文章ファイルの保存機能の基礎テスト その4　5つの文章ファイルを扱う
...
//各種設定部分
  ...
  //文書番号表示設定
		...
		titleb.font = '35px sans-serif';            // 35pxのゴシック体にする
            ...
            titleb.x = wiw * 0.0;                // 横位置調整
            titleb.y = wih * 0.0;               // 縦位置調整
...
　//読み込み準備　配列設定
	...
	wordkatakana.x = wiw * 0.04; // カタカナの入り口
        wordkatakana.y = wih * 0.18;
	wordkatakana.scaleX = scx;
	wordkatakana.scaleY = scy;
	wordbun.x = wiw * 0.04; // 文きりかえ
        wordbun.y = wih * 0.06;
	wordbun.scaleX = scx;
	wordbun.scaleY = scy;
	...
	wordhiragana.x = wiw * 0.04; // ひらがな
        wordhiragana.y = wih * 0.18;
