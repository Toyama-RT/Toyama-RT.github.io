...
window.onload = function() {
   ...
   /*     var title1 = new Label('');
	...
	//表示画像の設定
        var word1 = new Sprite(100, 100);  // word1　画像表示領域設定
        var word2 = new Sprite(100, 100);
        var word3 = new Sprite(100, 100);
        var word4 = new Sprite(100, 100);
	...
	word1.x =  wiw * 0.15 -50; // 横位置設定　左から幅
        word1.y =  wih * 0.8  -50; // 縦位置設定　上から高
	word1.scaleX = scx * 0.65; // 幅
	word1.scaleY = scy * 1.25; // 高
	word2.x =  wiw * 0.5 - 50;
        word2.y =  wih * 0.8 - 50;
	word2.scaleX = scx * 0.65 ;
	word2.scaleY = scy * 1.25 ;
	word3.x =  wiw * 0.85 -50;
        word3.y =  wih * 0.8  -50;
	word3.scaleX = scx * 0.65;
	word3.scaleY = scy * 1.25;
	word4.x =  wiw * -0.15 - 50;
        word4.y =  wih * 0.3  -50;
	word4.scaleX = scx * 0.65;
	word4.scaleY = scy * 1.25;
