enchant();// 簡易会話装置のサンプル　シンボル使用　４つのことば　４ページ　スキャン
...
/************************************************/
	...
	p4.scaleY = scy * 2;
        ...
        var title = new Label('あいさつ１');         //文字列表示
   ...
   /*         word1.addEventListener(Event.TOUCH_START, function(e) {  // word1をタッチしたら
        ...
        // グループの作成
        scanner.scene1.setScanTargets([word1,word2,word3,word4,p2,p3,p4]);
	...
	p4.scaleY = scy * 2;
        ...
        var title = new Label('あいさつ２');         //文字列の表示
            title.color = '#000000';                   // 文字色
...
*/
	...
	//表示する画像の設定
        ...
        var p3 = new Sprite(50, 50);
        var p4 = new Sprite(50, 50);
        word1.image = game_.assets['kotoba31.gif'];
...
*/
	...
	//表示する画像の設定
        ...
        var p3 = new Sprite(50, 50);
        var p4 = new Sprite(50, 50);
        word1.image = game_.assets['kotoba41.gif'];
	...
	p4.scaleY = scy * 2;
        ...
        var title = new Label('きもち');         //文字列の表示
            title.color = '#000000';                   // 文字色
		if (window.innerWidth > 1000){  //画面の大きさでフォント変更
		title.font = '60px sans-serif';            // 60pxのゴシック体
		} else if (window.innerWidth < 500){
...
*/
        ...
        // スキャンの設定を
        scanner.scene4.setScanSettingData(scanSetting2);
