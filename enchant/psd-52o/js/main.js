enchant();// 簡易会話装置のサンプル　シンボル使用　４つのことば　１ページ　スキャン
...
*/
        ...
        game_.preload('kotoba11.gif', 'kotoba11.mp3', 'kotoba12.gif', 'kotoba12.mp3', 'kotoba13.gif', 'kotoba13.mp3', 'kotoba14.gif', 'kotoba14.mp3', 'jump.mp3', 'gameover.mp3'); // pre-load:素材読込
...
/************************************************/
	...
	word4.scaleY = scy;
        ...
        // グループの作成
        scanner.scene1.setScanTargets([word1,word2,word3,word4]);
