...
*/
		...
		title0.y = 10;
            ...
            var title0e = new Label('30min Timer');
    ...
    game_.preload('arm03.gif', 'arm04.gif', 'arm05.gif', 'sw1.gif', 'dog1.mp3', 'sw2.gif', 'chick-cry1.mp3', 'sw3.gif', 'chicken-cry1.mp3', 'cat-cry1.mp3', 'jump.mp3', 'gameover.mp3');
// 感謝　効果音ラボ
