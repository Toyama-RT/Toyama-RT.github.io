...
*/
           game.fps = 30;
           game.preload ('./img/icon0.png', './snd/gameover.mp3', './snd/water-drop1.mp3', './snd/ba.mp3', './snd/na.mp3', './img/ba.png', './img/na.png', './img/ktba.png', './img/ktna.png', './img/banana2.png' );
        ...
        game.onload = function() {
	        ...
	        //表示する画像の設定
              ...
              }).delay(160).loop();// 指定フレーム待機してから繰り返す。5秒間隔
