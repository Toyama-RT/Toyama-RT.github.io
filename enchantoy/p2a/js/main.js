...
*/
           game.fps = 30;
           game.preload ('./img/icon0.png', './snd/gameover.mp3', './snd/water-drop1.mp3', './snd/ba.mp3', './snd/na.mp3', './img/ba.png', './img/na.png', './img/ktba.png', './img/ktna.png', './img/banana2.png', './img/arrow-up.png', './img/arrow-down.png' );
        ...
        game.onload = function() {
            ...
            arrowup.addEventListener(Event.TOUCH_END, function(e) {
                  speed = 0; 
            });
