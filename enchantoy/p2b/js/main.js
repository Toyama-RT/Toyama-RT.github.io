enchant();//物理エンジンのサンプル　No.7 バナナ3-2
...
*/
           game.fps = 30;
           game.preload ('./img/icon0.png', './snd/gameover.mp3', './snd/water-drop1.mp3', './snd/ba.mp3', './snd/na.mp3', './img/ba.png', './img/na.png', './img/ktba.png', './img/ktna.png', './img/banana2.png', './img/circle.png', './img/arrow-up-down.png' );
        ...
        game.onload = function() {
	        ...
	        //表示する画像の設定
                ...
                var arrowupdown = new Sprite(96, 96);
                ...
                arrowupdown.image = game.assets['./img/arrow-up-down.png'];
                ...
                arrowupdown.x = wiw * 0.1;
                arrowupdown.y = wih * 0.75;
                arrowupdown.scaleX = 1;
                arrowupdown.scaleY = 0.5;
                ...
                game.rootScene.addChild(arrowupdown);
              ...
              //タッチ（クリック）した際の動作
            arrowupdown.addEventListener(Event.TOUCH_START, function(e) {
                  speed = -1; 
            });
...
/*            arrowdown.addEventListener(Event.TOUCH_START, function(e) {
            ...
            arrowdown.addEventListener(Event.TOUCH_END, function(e) {
                  speed = 0; 
            });
*/
        }
