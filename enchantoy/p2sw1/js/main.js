enchant();//物理エンジンのサンプル　No.7 バナナ3.1 + sw1
...
*/
           game.fps = 30;
           game.preload ('./img/icon0.png', './snd/gameover.mp3', './snd/water-drop1.mp3', './snd/ba.mp3', './snd/na.mp3', './img/ba.png', './img/na.png', './img/ktba.png', './img/ktna.png', './img/banana2.png', './img/arrow-up.png', './img/arrow-down.png', './img/circle.png', './img/yellow.png' );
