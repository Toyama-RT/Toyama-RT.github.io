...
*/
           game.fps = 30;
           game.preload ('./img/icon0.png', './snd/gameover.mp3', './snd/water-drop1.mp3', './snd/ba.mp3', './snd/na.mp3', './img/ba.png', './img/na.png', './img/banana2.png', './img/red.png');
        ...
        game.onload = function() {
            ...
            red.addEventListener(Event.TOUCH_START, function(e) {
                  speed = speed0; 
            });
            red.addEventListener(Event.TOUCH_END, function(e) {
                  speed0 = speed;
                  speed = 0; 
            });
