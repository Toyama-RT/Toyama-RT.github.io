...
//　htmlの電話をかける部分に番号を組み入れる
 	...
 	mydiv1.innerHTML = '<a href="tel:' + pn1 + '"><img src="./youngman.gif" width="25%" alt="youngman"></a>';
        var mydiv2 = document.getElementById("idName2");
 	mydiv2.innerHTML = '<a href="tel:' + pn2 + '"><img src="./youngwoman.gif" width="25%" alt="younagwoman"></a>';
...
//　htmlの電話をかける部分に番号を組み入れる
 	...
 	mydiv.innerHTML = '<a href="tel:' + pn1 + '"><img src="./youngman.gif" width="25%" alt="youngman"></a>';
	console.log('<a href="tel:' + pn1 + '">電話をかける</a>');
}
...
//　htmlの電話をかける部分に番号を組み入れる
 	...
 	mydiv.innerHTML = '<a href="tel:' + pn2 + '"><img src="./youngwoman.gif" width="25%" alt="yangwoman"></a>';
