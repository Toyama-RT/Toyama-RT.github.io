...
//画面大きさ表示部分
  ...
  //画面サイズの表示
   function window_load() {
	...
	//document.getElementById("winsize2").innerHTML = s;//ここが表示部分
   }
//文書ファイル保存機能
  //local storage 関係宣言
   var SERVICE_NAME0 = 'SERVICE_NAME0';//前回使用した文番号を示す
   var storage0;
   var SERVICE_NAME1 = 'SERVICE_NAME1';//文1
   var storage1 = null;
   var SERVICE_NAME2 = 'SERVICE_NAME2';//文2
   var storage2 = null;
  ...
  //開始時　local storage  から読み込み
        storage0 = localStorage.getItem('SERVICE_NAME0');
            ...
            if (storage0 == 1 ){  //初回起動時にstrage0=nullとなるのを1にして不具合を回避する処理
               storage0 =  1;
            } else if (storage0 == 2 ) {
               storage0 =  2;
            } else if (storage0 == 3 ) {
...
//文字盤判別番号
   var CBoard0 = 0;  // 0=> hiragana 1=> katakana 2=> aisatu 3=> karada

      location.href = '#text1';

//テキストボックスへの初期文字列の書き込み部
     var text1 = document.getElementById("text1");
     //var text2 = document.getElementById("text2");　　　これ不要
