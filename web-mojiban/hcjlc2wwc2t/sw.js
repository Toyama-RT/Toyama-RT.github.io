  ...
  e.waitUntil(
    caches.open(CACHE_NAME).then(cache => {
      ...
      return cache.addAll([
        ...
        path + `/img6/hannko.png`,
        path + `/img6/sinnsyoutecyou.png`,
