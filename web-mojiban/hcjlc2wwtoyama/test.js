...
function CBoardChange(param1){
      ...
      switch (param1) {
        case 0:
          ...
          elemmo.src = "./img/00.png";
          elemya.src = "./img/00.png";
          elemyu.src = "./img/00.png";
          elemyo.src = "./img/00.png";
          elemyo2.src = "./img/00.png";
          elemyo3.src = "./img/00.png";
          elemra.src = "./img/00.png";
          elemri.src = "./img/00.png";
          elemru.src = "./img/00.png";
          elemre.src = "./img/00.png";
          elemro.src = "./img/00.png";
          elemwa.src = "./img/00.png";
          elemwo.src = "./img/00.png";
          elemnn.src = "./img/00.png";
          elemnn2.src = "./img/00.png";
          elemnn3.src = "./img/00.png";
          break;
        case 1:
/*          elem.src = "./img/hiragana.png";
