...
console.log("deg =", deg, deg * DEG_TO_RAD);
	...
	createBody3(type, x, y, w, h, deg, boxImg){
		...
		this._bodyDef.angle = deg * DEG_TO_RAD;
		this._bodyDef.type = type;
		this._bodyDef.userData = {shape_type: 'box', img: boxImg, width: 200, height: 200};//img;//null;
	...
	var ver1=new b2Vec2( -4, -4);
	var ver2=new b2Vec2( +4, -4);
	var ver3=new b2Vec2( +4, +4);
	...
	vertexArray.push(ver1, ver2, ver3);
		...
		this._bodyDef.angle = deg * DEG_TO_RAD;
		this._bodyDef.type = type;
		this._bodyDef.userData = {shape_type: 'box', img: Img, width: 240, height: 240};//img;//null;
