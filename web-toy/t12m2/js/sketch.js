...
if (canvas.height <= 525 ) {
  ...
  console.log("figwidth" + " %d", figwidth);
	...
	createFrame();
		...
		let rjRot = manager.createTorqueJoint(cBody, rBody, canvas.width * 50 / 100, canvas.height * 50 / 100, 1000, 10);//0.5, 0);
...
console.log("%d", countclick);
		...
		let rjRot = manager.createTorqueJoint(cBody, rBody, canvas.width * 50 / 100, canvas.height * 50 / 100, 1000, 10);
		let rjRot2 = manager.createTorqueJoint(cBody, rBody, canvas.width * 50 / 100, canvas.height * 50 / 100, 1000, 10);
...
//rBody.SetAwake(true); // sleepstate  make awake here
	...
	function handleMouseUp(){
		...
		let rjRot = manager.createTorqueJoint(cBody, rBody, canvas.width * 50 / 100, canvas.height * 50 / 100, 1000, 0);
		let rjRot2 = manager.createTorqueJoint(cBody, rBody, canvas.width * 50 / 100, canvas.height * 50 / 100, 1000, 0);
		//let rjRot3 = manager.createTorqueJoint(cBody, rBody, canvas.width * 50 / 100, canvas.height * 50 / 100, 1000, 0);
