...
console.log("canvasPosition x =", canvasPosition.x);
console.log("canvasPosition y =", canvasPosition.y);
...
console.log("WIDTH HEIGHT =", C_WIDTH, C_HEIGHT);
//console.log("WIDTH 2 HEIGHT 2=", window.innerWidth, window.innerHeight);
...
//マウスが右なら　いやいや　左なら　うんうん
      if(clientX > (C_WIDTH2/2)){
        var elemdog = document.getElementById("image_dog2");
            elemdog.src = "./shb.gif";
        audioElem = new Audio();
         audioElem.src = "./iyaiya.mp3";
        audioElem.play();

      }else{
        var elemdog = document.getElementById("image_dog");
            elemdog.src = "./nodd.gif";
        audioElem = new Audio();
         audioElem.src = "./unun.mp3";
        audioElem.play();
      }
...
//mouseup ; stop head in 5sec.５秒後に動画から静止画へ変更する

setTimeout(() => {
      var elemdog = document.getElementById("image_dog");
          elemdog.src = "./nod1.gif";
      var elemdog = document.getElementById("image_dog2");
          elemdog.src = "./sh1.gif";
  },7000)
...
if(clientX > (C_WIDTH2/2-512/2)+470 && clientX <(C_WIDTH2/2-512/2)+500 && clientY >230 && clientY < 250){
//(C_WIDTH/2-512/2)+170

console.log("clientX hit", clientX, clientY);
//      var elemdog = document.getElementById("image_dog");
//          elemdog.src = "./dogf2.gif";
//setTimeout(function(){
...
if((clientX > (C_WIDTH2/2-512/2)+210 && clientX <(C_WIDTH2/2-512/2)+310 && clientY >170 && clientY < 190) || 
(clientX > (C_WIDTH2/2-512/2)+120 && clientX <(C_WIDTH2/2-512/2)+150 && clientY >70 && clientY < 85)){
