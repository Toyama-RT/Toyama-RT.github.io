...
function init() {
  heading.textContent = "Voice-change HIGHER ECHO";
  ...
  function visualize() {
    ...
    //visualSetting = "frequencybars"; // visualSetting is still "frequencybars"
    ...
    if (visualSetting === "sinewave") {
      ...
      const drawAlt = function () {
        ...
        const barWidth = (WIDTH / bufferLengthAlt) * 10.0;
        let barHeight;
        let x = 0;
        ...
        for (let i = 0; i < bufferLengthAlt; i++) {
          ...
          canvasCtx.fillStyle = "rgb(" + (barHeight + 150) + "," + (barHeight + 150) + ",20)";
          canvasCtx.fillRect(
            x,
            HEIGHT - barHeight / 2,
            barWidth,
  ...
  function voiceChange() {
    ...
    //voiceSetting = "delay"; // voiceSetting is still "delay"
  ...
  function createEchoDelayEffect(audioContext) {
    ...
    dryNode.gain.value = 0.05;
    wetNode.gain.value = 0.95;
  ...
  function voiceMute() {
    if (mute.id === "") {
      ...
      mute.id = "activated";
      mute.innerHTML = "Sorry  you can't mute";
    } else {
      //gainNode.gain.value = 0;
      mute.id = "";
      mute.innerHTML = "Mute";
